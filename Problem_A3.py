...
def solution_A3():
    ...
    # REMEMBER TO ALWAYS SET WEIGHTS TO IMAGENET... DON'T INITIATE WITH NONE YOU DOOM YOURSELF (In this case)
    ...
    model.compile(optimizer=RMSprop(learning_rate=0.0001),
                  ...
                  metrics=['acc'])
    model.fit(train_generator, validation_data=val_generator, epochs=200,steps_per_epoch=10, verbose=2,callbacks=[myCallback()])
